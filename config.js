...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://vinnie:sanga1234@cluster0.rpndk6j.mongodb.net/?retryWrites=true&w=majority" ;
...
module.exports = {
  sessionName: process.env.SESSION_ID || "WidenLunatics",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'Vinnie-ᴍᴅ',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It's Vinnie`,
  author:  process.env.PACK_AUTHER || 'Vincent',
  errorChat : process.env.ERROR_CHAT|| '', // put 'chat' here to send error in chat ,where it accures
  read_status : process.env.AUTO_READ_STATUS || 'truee',
